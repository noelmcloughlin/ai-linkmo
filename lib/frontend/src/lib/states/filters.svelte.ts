...
// Single source of truth for all filter field metadata
export const DROPDOWN_FIELDS = [
  {
    key: "schema-field-select",
    param: "schemaField",
    label: "Schema field",
  ...
  {
    key: "param-document-input",
    param: "hasDocumentation",
    label: "Documentation",
    select: "dropdownDoc",
    isArray: true,
  },
  {
    key: "param-taxonomy-input",
    param: "isDefinedByTaxonomy",
    label: "Taxonomy",
    select: "dropdownTaxonomy",
    isArray: false,
  },
  {
    key: "param-type-input",
    param: "type",
    label: "Type",
  ...
  {
    key: "param-risk-type-input",
    param: "risk_type",
    label: "Risk Type",
    select: "dropdownRiskTypes",
    isArray: false,
  },
  {
    key: "param-adapter-type-input",
    param: "hasAdapterType",
    label: "Adapter Type",
    select: "dropdownAdapterTypes",
    isArray: false,
  },
  {
    key: "param-license-input",
    param: "hasLicense",
    label: "License",
    select: "dropdownLicense",
    isArray: false,
  },
  {
    key: "param-grants-license-input",
    param: "grants_license",
    label: "Grants License",
    select: "dropdownGrantsLicense",
    isArray: false,
  },
  {
    key: "param-partof-input",
    param: "isPartOf",
    label: "Part Of",
    select: "dropdownPartOf",
    isArray: false,
  },
  {
    key: "param-vocabulary-input",
    param: "isDefinedByVocabulary",
    label: "Vocabulary",
    select: "dropdownVocabulary",
    isArray: false,
  },
  {
    key: "param-dataset-input",
    param: "hasDataset",
    label: "Dataset",
    select: "dropdownDataset",
    isArray: true,
  },
  {
    key: "param-provider-input",
    param: "provider",
    label: "Provider",
  ...
  {
    key: "param-evidence-input",
    param: "hasEvidenceCategory",
    label: "Evidence",
    select: "dropdownEvidence",
    isArray: true,
  },
  {
    key: "param-typical-location-input",
    param: "hasTypicalLocation",
    label: "Typical Location",
    select: "dropdownTypicalLocation",
    isArray: true,
  },
  {
    key: "param-application-input",
    param: "hasControlApplication",
    label: "Control Application",
    select: "dropdownApplication",
    isArray: false,
  },
  {
    key: "param-performs-task-input",
    param: "performsTask",
    label: "Performs Task",
    select: "dropdownPerformsTask",
    isArray: true,
  },
  {
    key: "param-task-input",
    param: "hasTasks",
    label: "Has Tasks",
    select: "dropdownTask",
    isArray: true,
  ...
  {
    key: "param-required-by-task-input",
    param: "requiredByTask",
    label: "Required By Task",
    select: "dropdownRequiredByTask",
    isArray: true,
  },
  {
    key: "param-actor-task-input",
    param: "hasAiActorTask",
    label: "Actor Task",
    select: "dropdownActorTask",
    isArray: true,
  },
  {
    key: "param-has-domains-input",
    param: "hasDomains",
    label: "Domain",
    select: "dropdownHasDomains",
    isArray: false,
  },
  {
    key: "param-belongs-domains-input",
    param: "belongsToDomain",
    label: "Belongs To Domain",
    select: "dropdownBelongsToDomain",
    isArray: false,
  },
  {
    key: "param-part-input",
    param: "hasPart",
    label: "has Part",
    select: "dropdownPart",
    isArray: false,
  ...
  {
    key: "param-detects-input",
    param: "detectsRiskConcept",
    label: "Detects",
    select: "dropdownDetects",
    isArray: true,
  },
  {
    key: "param-detected-by-input",
    param: "isDetectedBy",
    label: "Detected By",
    select: "dropdownDetectedBy",
    isArray: false,
  },
  {
    key: "param-phase-input",
    param: "phase",
    label: "Phase",
    select: "dropdownPhase",
    isArray: false,
  },
  {
    key: "param-has-control-input",
    param: "hasRiskControl",
    label: "Risk Controls",
    select: "dropdownRiskControl",
    isArray: true,
  },
  {
    key: "param-refers-to-input",
    param: "refersToRisk",
    label: "Refers To",
    select: "dropdownRefersTo",
    isArray: true,
  },
  {
    key: "param-status-input",
    param: "hasStatus",
    label: "has Status",
  ...
  {
    key: "param-severity-input",
    param: "hasSeverity",
    label: "has Severity",
    select: "dropdownSeverity",
    isArray: false,
  },
  {
    key: "param-likelihood-input",
    param: "hasLikelihood",
    label: "has Likelihood",
    select: "dropdownLikelihood",
    isArray: false,
  },
  {
    key: "param-impact-on-input",
    param: "hasImpactOn",
    label: "has Impact On",
    select: "dropdownImpactOn",
    isArray: false,
  },
  {
    key: "param-rule-input",
    param: "hasRule",
    label: "has Rule",
    select: "dropdownRule",
    isArray: true,
  ...
  {
    key: "param-impact-input",
    param: "hasImpact",
    label: "Impact",
    select: "dropdownImpact",
    isArray: false,
  },
  {
    key: "param-consequence-input",
    param: "hasConsequence",
    label: "has Consequence",
    select: "dropdownConsequence",
    isArray: false,
  },
  {
    key: "param-describes-eval-input",
    param: "describesAiEval",
    label: "Describes Eval",
    select: "dropdownDescribesEval",
    isArray: false,
  },
  {
    key: "param-evaluation-input",
    param: "hasEvaluation",
    label: "has Evaluation",
    select: "dropdownEvaluation",
    isArray: false,
  },
  {
    key: "param-descriptor-input",
    param: "descriptor",
    label: "Descriptor",
    select: "dropdownDescriptor",
    isArray: true,
  },
  {
    key: "param-import-capability-input",
    param: "implementsCapability",
    label: "import Capability",
    select: "dropdownImplementsCapability",
    isArray: true,
  },
  {
    key: "param-applies-to-capability-input",
    param: "appliesToCapability",
    label: "Applies To Capability",
    select: "dropdownAppliesToCapability",
    isArray: false,
  },
  {
    key: "param-requires-capability-input",
    param: "requiresCapability",
    label: "Requires Capability",
    select: "dropdownRequiresCapability",
    isArray: true,
  },
  {
    key: "param-adapter-input",
    param: "hasAdapter",
    label: "Adapter",
    select: "dropdownAdapter",
    isArray: true,
  },
  {
    key: "param-implemented-by-adapter-input",
    param: "implementedByAdapter",
    label: "Implemented By Adapter",
    select: "dropdownImplementedByAdapter",
    isArray: true,
  },
  {
    key: "param-term-input",
    param: "hasTerm",
    label: "has Term",
    select: "dropdownTerm",
    isArray: false,
  ...
  {
    key: "param-input-modality-input",
    param: "hasInputModality",
    label: "Input Modality",
    select: "dropdownInputModality",
    isArray: true,
  },
  {
    key: "param-output-modality-input",
    param: "hasOutputModality",
    label: "Output Modality",
    select: "dropdownOutputModality",
    isArray: true,
  },
  {
    key: "param-requirement-input",
    param: "hasRequirement",
    label: "Requirement",
    select: "dropdownRequirement",
    isArray: false,
  },
  {
    key: "param-requirement-type-input",
    param: "hasRequirementType",
    label: "Requirement Type",
    select: "dropdownRequirementType",
    isArray: false,
  },
  {
    key: "param-related-action",
    param: "hasRelatedAction",
    label: "Related Actions",
    select: "dropdownRelatedAction",
    isArray: true,
  },
  {
    key: "param-related-risk",
    param: "hasRelatedRisk",
    label: "Related Risks",
    select: "dropdownRelatedRisk",
    isArray: true,
  },
  {
    key: "param-broad-mappings",
    param: "broad_mappings",
    label: "Broad Mappings",
    select: "dropdownBroadMappings",
    isArray: true,
  },
  {
    key: "param-close-mappings",
    param: "close_mappings",
    label: "Close Mappings",
    select: "dropdownCloseMappings",
    isArray: true,
  },
  {
    key: "param-narrow-mappings",
    param: "narrow_mappings",
    label: "Narrow Mappings",
    select: "dropdownNarrowMappings",
    isArray: true,
  },
  {
    key: "param-exact-mappings",
    param: "exact_mappings",
    label: "Exact Mappings",
    select: "dropdownExactMappings",
    isArray: true,
  },
  {
    key: "param-related-mappings",
    param: "related_mappings",
    label: "Related Mappings",
    select: "dropdownRelatedMappings",
    isArray: true,
  },
] as const;
...
const PARAM_TO_DROPDOWN = Object.fromEntries(
  DROPDOWN_FIELDS.map((f) => [f.param, f.select]),
);
const ARRAY_FIELDS = DROPDOWN_FIELDS.filter((f) => f.isArray).map(
  (f) => f.param,
);
export const ALL_PARAMS = [
  ...DROPDOWN_FIELDS.map((f) => f.param),
  "searchText",
  "paramId",
  "isRelatedMode",
] as const;
// Params that should be used for filtering (excludes schemaField, searchText, paramId, isRelatedMode)
const FILTER_PARAMS = DROPDOWN_FIELDS.filter(
  (f) => f.param !== "schemaField",
).map((f) => f.param);
// Params that should be checked for "active filters" UI (excludes schemaField and isRelatedMode)
export const ACTIVE_FILTER_PARAMS = [
  ...FILTER_PARAMS,
  "searchText",
  "paramId",
] as const;
...
class FilterState {
  ...
  // Special state for related mode
  // This is used to toggle related mode in the UI.
  // It triggers UI updates by fetching 'related records' data.
  // It is mapped to 'related' API param for backend.
  ...
  dropdownTypicalLocation = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownApplication = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownPerformsTask = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownTask = $state([{ label: "", value: "" }] as DropdownOptionType[]);
  dropdownRequiredByTask = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownActorTask = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownDataset = $state([{ label: "", value: "" }] as DropdownOptionType[]);
  dropdownHasDomains = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRiskControl = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownBelongsToDomain = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  ...
  dropdownLikelihood = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownImpactOn = $state([{ label: "", value: "" }] as DropdownOptionType[]);
  dropdownImpact = $state([{ label: "", value: "" }] as DropdownOptionType[]);
  dropdownConsequence = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownDescribesEval = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownEvaluation = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownDescriptor = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownImplementsCapability = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownAppliesToCapability = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRequiresCapability = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownAdapter = $state([{ label: "", value: "" }] as DropdownOptionType[]);
  dropdownImplementedByAdapter = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownTerm = $state([{ label: "", value: "" }] as DropdownOptionType[]);
  dropdownInputModality = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownOutputModality = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRequirement = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRequirementType = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRelatedAction = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRelatedRisk = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownBroadMappings = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownCloseMappings = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownNarrowMappings = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownExactMappings = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);
  dropdownRelatedMappings = $state([
    { label: "", value: "" },
  ] as DropdownOptionType[]);

  getParam(param: string): string | number | boolean | null {
    return param in this
      ? (this[param] as string | number | boolean | null)
      : null;
  }
  ...
  getAllParamValues() {
    ...
    for (const key of ALL_PARAMS) {
      if (key in this) {
        // Creates reactive dependency on each tracked field.
        values[key] = (
          this as unknown as Record<string, string | number | boolean>
        )[key];
      }
    }
    return values;
  ...
  reset(except: Array<string> = []) {
    ...
    // Reset all param fields to empty string (derived from DROPDOWN_FIELDS + extras)
    ...
    // Clear all dropdown options (derived from DROPDOWN_FIELDS)
  ...
  getOptions(param: string) {
    // Use derived mapping instead of manual dropdownMap
    const select = PARAM_TO_DROPDOWN[param];
    let items: DropdownOptionType[] = select
      ? (this[select] as DropdownOptionType[])
      : [];

    // If the only entry is empty, treat as empty
    if (
      Array.isArray(items) &&
      items.length === 1 &&
      items[0].label === "" &&
    ...
    // Use derived ARRAY_FIELDS instead of hardcoded list
  ...
  setDropdownOptions(items: unknown[]) {
    ...
    // Use derived list instead of manual array
    ...
    this.dropdownDoc =
      docOptions.length > 0 ? docOptions : [{ label: "", value: "" }];
  }

  filterItem(endpoint: string, item: DropdownOptionType): boolean {
    // Check paramId first (client-side ID filtering with prefix match)
    // Skip paramId filtering when in related mode - paramId is the query source, not a filter
    ...
    for (const param of FILTER_PARAMS) {
      // Skip hasRelatedAction and hasRelatedRisk filtering when in related mode
      ...
      if (val && typeof val === "string") {
        const checkFn =
          CUSTOM_FILTER_CHECKS[param] || defaultFilterCheck(param);
...
// This is used in the RecordForm to dynamically determine which endpoint
...
// Helper to extract field values (used in multiple places)
...
const CUSTOM_FILTER_CHECKS: Record<
  string,
  (val: string, item: DropdownOptionType, context: FilterState) => boolean
> = {
  hasDocumentation: (val, item) => {
    const docs = item.hasDocumentation;
    const valLower = safeLower(val).toString();
    if (Array.isArray(docs))
      return docs.some((doc) => safeLower(doc).toString().includes(valLower));
    return safeLower(String(docs ?? ""))
      .toString()
      .includes(valLower);
  },
};
...
const defaultFilterCheck = (param: string) => {
  const isArrayField = ARRAY_FIELDS.includes(
    param as (typeof ARRAY_FIELDS)[number],
  );
  return (val: string, item: DropdownOptionType) => {
    const fieldValue = isArrayField
      ? extractFieldValue((item as Record<string, unknown>)[param])
      : String((item as Record<string, unknown>)[param] || "");
