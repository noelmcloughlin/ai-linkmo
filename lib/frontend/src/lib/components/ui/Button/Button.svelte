  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        outline:
          'bg-transparent border-2 border-slate-400 text-slate-700 hover:bg-slate-100 focus:ring-slate-400',
        info: 'bg-blue-500 hover:bg-blue-600 text-white focus:ring-blue-400 active:bg-blue-700',
        success:
          'bg-green-500 hover:bg-green-600 text-white focus:ring-green-400 active:bg-green-700',
        curate: 'bg-red-600 hover:bg-red-700 text-white focus:ring-red-400 active:bg-red-800',
        login:
          'bg-white text-blue-700 font-semibold border border-blue-200 hover:bg-blue-50 shadow focus:ring-blue-300 min-w-[48px]',
